...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def show_about_dialog(self):
        ...
        about_text = (
            "<h2>YuanGIS</h2>"
            "<p>版本: 1.4 | 开源协议: MIT</p>"
            "<p>项目地址：<a href='https://github.com/yourusername/yuangis'>github.com/yourusername/yuangis</a></p>"
            "<p>项目描述：一个轻量级教学用GIS平台，支持空间数据管理与可视化分析。</p>"
            "<p>开发者：邹卓江</p>"
            "<p>学术指导：屈永华 教授</p>"
            "<h3>开源致谢</h3>"
            "<p>本软件基于开源项目 BanyanGIS 二次开发，特别感谢其开发者提供的核心技术支持。</p>"
            "<p>原项目地址：<a href='https://github.com/BeanJ/BanyanGIS'>github.com/banyangis</a></p>"
        )
